...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showServiceLoginForm()
    {
        return view('auth.login', ['url' => 'service']);
    }
    ...
    public function serviceLogin(Request $request)
    {
        ...
        if (Auth::guard('service')->attempt(['email' => $request->email, 'password' => $request->password], $request->get('remember'))) {

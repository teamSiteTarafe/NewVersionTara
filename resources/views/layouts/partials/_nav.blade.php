...
<div class="barre1 row">
    ...
    <p class="compte col-auto"><a href="dashboard.php">dashboard</a><a href="{{ url('/compte')}}" class="btn"><img class="logo_compte" src="{{ asset('assets/img/compte.png') }}" alt=""> compte</a></p>
</div>
...
<div class="barre3 row">
    <div class="barre_bouton">
        <ul class="ul_bouton row">
            <li class="li_bouton"><a href="" class="btn nbt">Produits</a></li>
            <span class="0separator00"></span>
            <li class="li_bouton"><a href="" class="btn nbt">Boutiques</a></li>
            <span class="0separator00"></span>
            <li class="li_bouton"><a href="" class="btn nbt">Services</a></li>
            <span class="0separator00"></span>
        ...
        <li class="li_bouton"><a href="{{ route('blog')}}" class="btn nbt">Blog</a></li>
            ...
            <span class="0separator00"></span>
            <li class="li_bouton d_h"><a href="{{ route('login') }}" class="btn nbt">Connexion</a></li>
            <span class="0separator00"></span>
            <li class="li_bouton d_h"><a href="{{ route('register') }}" class="btn nbt">Inscription</a></li>
        </ul>
    </div>
    ...
    <div class="div_connexion">
        @if(!Auth::check())
            <div class="div_connexion2">
                <a href="{{ route('login') }}" class="btn nbt">Connexion</a>
                <span class="0separator00"></span>
                <a href="{{ route('register') }}" class="btn nbt">Inscription</a>
            </div>
        @else
            <a style="color:white;margin-top: 10px;" class="btn nbt" href="{{ route('logout') }}"
